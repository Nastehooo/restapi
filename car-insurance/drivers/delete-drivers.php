                                    ...
                                    <form action="drivers-code.php" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="MSTATUS" value="<?= $data['MSTATUS'] ?>" placeholder="Enter Driver's mstatus" class="form-control">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="">GENDER</label>
                                                <input type="text" name="GENDER" value="<?= $data['GENDER'] ?>" placeholder="Enter the gender of a Driver" class="form-control">
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <!-- Add delete button for driver -->
                                                <button type="submit" class="btn btn-danger" name="delete_driver_button">Delete</button>
                                            </div>
                                        </div>
                                    </form>
                            </div>
